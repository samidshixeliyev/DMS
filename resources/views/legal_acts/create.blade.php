...
@section('title', 'Create Legal Act')
    ...
    <div class="col-md-10 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-plus-circle"></i> Create New Legal Act</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('legal-acts.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('legal_act_number') is-invalid @enderror" 
                                   id="legal_act_number" name="legal_act_number" value="{{ old('legal_act_number') }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('legal_act_date') is-invalid @enderror" 
                                   id="legal_act_date" name="legal_act_date" value="{{ old('legal_act_date') }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('issued_by_id') is-invalid @enderror" 
                                ...
                                @foreach($issuingAuthorities as $authority)
                                    <option value="{{ $authority->id }}" {{ old('issued_by_id') == $authority->id ? 'selected' : '' }}>
                                        {{ $authority->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('execution_deadline') is-invalid @enderror" 
                                   id="execution_deadline" name="execution_deadline" value="{{ old('execution_deadline') }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('task_number') is-invalid @enderror" 
                                   id="task_number" name="task_number" value="{{ old('task_number') }}">
                            @error('task_number')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('related_document_number') is-invalid @enderror" 
                                   id="related_document_number" name="related_document_number" value="{{ old('related_document_number') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('related_document_date') is-invalid @enderror" 
                                   id="related_document_date" name="related_document_date" value="{{ old('related_document_date') }}">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save"></i> Create Legal Act
                        </button>
                    </div>
                </form>
            </div>
