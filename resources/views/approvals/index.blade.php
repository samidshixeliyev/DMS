...
@push('styles')
<style>
    .row-pending td { background-color: #fefce8 !important; }
    .row-pending:hover td { background-color: #fef9c3 !important; }
    .row-pending td:first-child { box-shadow: inset 3px 0 0 #ca8a04; }

    #approvalsTable tbody td { font-size: 0.82rem; padding: 0.5rem 0.65rem; vertical-align: middle; text-align: center; }
    #approvalsTable tbody td.wrap-cell { white-space: normal; word-break: break-word; text-align: left; min-width: 150px; max-width: 250px; }
    ...
    .approval-badge-pending { background: #fbbf24; color: #92400e; }
    .approval-badge-approved { background: #34d399; color: #065f46; }
    .approval-badge-rejected { background: #fb7185; color: #9f1239; }
</style>
@endpush
            ...
            <form id="approveForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="approval_note" class="form-control" rows="3" placeholder="Təsdiq qeydini yazın..."></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">İmtina</button>
                    <button type="submit" class="btn btn-success"><i class="bi bi-check-circle me-1"></i> Təsdiqlə</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="rejectForm" method="POST">
                ...
                <div class="modal-body">
                    <p class="text-danger fw-semibold">Bu sənədin icrasını rədd edirsiniz. İcraçı yenidən status təyin edəcək.</p>
                    <div class="mb-3">
                        <label class="form-label">Rədd səbəbi <span class="text-danger">*</span></label>
                        <textarea name="approval_note" class="form-control" rows="3" placeholder="Rədd səbəbini mütləq yazın..." required></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">İmtina</button>
